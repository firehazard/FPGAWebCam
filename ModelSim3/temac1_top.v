...
module temac1_top
  ...
  IBUF drive_gmii_rx_dv(.I(gmii_rx_dv2), .O(gmii_rx_dv_ibuf));
  IBUF drive_gmii_rx_er(.I(gmii_rx_er), .O(gmii_rx_er_ibuf));

  IBUF drive_gmii_rxd0(.I(gmii_rxd2[0]), .O(gmii_rxd_ibuf[0]));
  IBUF drive_gmii_rxd1(.I(gmii_rxd2[1]), .O(gmii_rxd_ibuf[1]));
  IBUF drive_gmii_rxd2(.I(gmii_rxd2[2]), .O(gmii_rxd_ibuf[2]));
  IBUF drive_gmii_rxd3(.I(gmii_rxd2[3]), .O(gmii_rxd_ibuf[3]));
  IBUF drive_gmii_rxd4(.I(gmii_rxd2[4]), .O(gmii_rxd_ibuf[4]));
  IBUF drive_gmii_rxd5(.I(gmii_rxd2[5]), .O(gmii_rxd_ibuf[5]));
  IBUF drive_gmii_rxd6(.I(gmii_rxd2[6]), .O(gmii_rxd_ibuf[6]));
  IBUF drive_gmii_rxd7(.I(gmii_rxd2[7]), .O(gmii_rxd_ibuf[7]));
